...
const repositories = [
  {
    id: "18f386fb-86ec-43be-badc-49593592bafa",
    title: "Umbr",
...
app.put("/repositories/:id", (request, response) => {
  ...
  repositories[projectIndex].title = project.title;
  repositories[projectIndex].url = project.url;
  repositories[projectIndex].techs = project.techs;
